...
# translation
SOURCES = a.py ui_a.py __init__.py adialog.py
#TRANSLATIONS = i18n/a_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = projectadmin

PY_FILES = ProjectAdmin.py ProjectAdminDialog.py __init__.py confDlgDialog.py saveProjectDlgDialog.py

EXTRAS = icon/icon.png 

UI_FILES = ProjectAdmin_ui.py saveProjectDlg.py confDlg.py
